...
btnClose.addEventListener('click', function (e) {
  ...
  // // Мой способ записи этой фичи

  // const nickname = inputCloseUsername.value;
  // const pin = inputClosePin.value;
  // const testDannyx = (nickname, pin) =>
  //   nickname == currentAccount.nickname && pin == currentAccount.pin
  //     ? console.log('Введенные данные для удаления верны')
  //     : console.log('Данные аккаунта введены не верно');
  // testDannyx(nickname, pin);
